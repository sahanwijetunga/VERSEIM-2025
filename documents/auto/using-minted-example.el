...
(TeX-add-style-hook
 ...
 (lambda ()
   ...
   (TeX-add-to-alist 'LaTeX-provided-package-options
                     '(("fontspec" "") ("minted" "") ("xcolor" "svgnames")))
   (add-to-list 'LaTeX-verbatim-environments-local "leancode")
   ...
   (add-to-list 'LaTeX-verbatim-macros-with-braces-local "lean")
   (add-to-list 'LaTeX-verbatim-macros-with-braces-local "EscVerb*")
   (add-to-list 'LaTeX-verbatim-macros-with-braces-local "EscVerb")
   (add-to-list 'LaTeX-verbatim-macros-with-braces-local "Verb*")
   (add-to-list 'LaTeX-verbatim-macros-with-braces-local "Verb")
   (add-to-list 'LaTeX-verbatim-macros-with-delims-local "lean")
